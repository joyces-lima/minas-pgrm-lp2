...
if (valorTotal >= 150) {
  ...
  // Se o total for menor que vinte, então o pedido mínimo não foi atingido enão tem frete disponivel
  mensagem = "Pedido mínimo não foi atingido - Frete indisponivel"
} else if (valorTotal >= 20) {
  // Se o total for maior ou igual a 20 (mas menor que 150), a mensagem deve ser 'Frete: R$ 20.00 😅'
